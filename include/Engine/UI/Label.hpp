...
public:
    Label(Window* window, glm::vec2 position, glm::vec2 anchor, std::string text, char* font = "assets/fonts/arial.ttf", int alignment = (TextAlignement::ALIGN_LEFT | TextAlignement::ALIGN_BOTTOM),  float fontHeight = 24, glm::vec3 fontColor = glm::vec3(1.0f));
